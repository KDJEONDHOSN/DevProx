...
--   This Is The Source Channel @tft4t .   --
--                - DevProx -                 --
--        -- https://t.me/tft4t --         --
------------------------------------------------ 
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'حمد')
--     Source DevProx     --
...
--     Source DevProx     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then KDJEONDHOSN  = "المطور" elseif SecondSudo(msg) then KDJEONDHOSN = "المطور" elseif SudoBot(msg) then KDJEONDHOSN = "المطور" elseif ManagerAll(msg) then KDJEONDHOSN = "المدير" elseif AdminAll(msg) then KDJEONDHOSN = "الادمن" elseif AbsConstructor(msg) then KDJEONDHOSN = "المالك" elseif BasicConstructor(msg) then KDJEONDHOSN = "المنشئ" elseif Constructor(msg) then KDJEONDHOSN = "المنشئ" elseif Manager(msg) then KDJEONDHOSN = "المدير" elseif Admin(msg) then KDJEONDHOSN = "الادمن" else KDJEONDHOSN = "العضو" end return KDJEONDHOSN end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1619524486) then KDJEONDHOSN = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(DevProx) then KDJEONDHOSN = 'البوت' elseif SudoId(user_id) then KDJEONDHOSN = 'المطور الاساسي' elseif DevAbs:sismember(DevProx..'Abs:SecondSudo:', user_id) then KDJEONDHOSN = 'المطور الثانوي' elseif DevAbs:sismember(DevProx..'Abs:SudoBot:', user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(DevProx..'Abs:ManagerAll:', user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAbs:sismember(DevProx..'Abs:AdminAll:', user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAbs:sismember(DevProx..'Abs:VipAll:', user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAbs:sismember(DevProx..'Abs:AbsConstructor:'..chat_id, user_id) then KDJEONDHOSN = 'المالك' elseif DevAbs:sismember(DevProx..'Abs:BasicConstructor:'..chat_id, user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(DevProx..'Abs:Constructor:'..chat_id, user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(DevProx..'Abs:Managers:'..chat_id, user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(DevProx..'Abs:Admins:'..chat_id, user_id) then KDJEONDHOSN = DevAbs:get(DevProx.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(DevProx..'Abs:VipMem:'..chat_id, user_id) then  KDJEONDHOSN = DevAbs:get(DevProx.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(DevProx..'Abs:Cleaner:'..chat_id, user_id) then  KDJEONDHOSN = DevAbs:get(DevProx.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else KDJEONDHOSN = DevAbs:get(DevProx.."Abs:mem:Rd"..chat_id) or 'العضو' end return KDJEONDHOSN end
--     Source DevProx     --
...
local UserName = (dp.username_ or "tft4t")
...
⌁︙م6 ↫ اوامر الاعضاء
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Source Channel](https://t.me/tft4t)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "حمد")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "حمد")..' ','')
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'tft4t')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'tft4t')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌁︙اهلا بك مجددا عزيزي المطور \n⌁︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس حمد فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "tft4t")..')', 1, 'md') 
...
local KDJEONDHOSN = '⌁︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌁︙تم تفعيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, KDJEONDHOSN, 14, string.len(msg.sender_user_id_))
...
local KDJEONDHOSN =  DevAbs:smembers(DevProx..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..KDJEONDHOSN[math.random(#KDJEONDHOSN)]..']' , 1, 'md')  
end
end
--     Source DevProx     --
...
function KDJEONDHOSN(extra,result,success)
...
getUser(msg.sender_user_id_, KDJEONDHOSN)
end
end
--     Source DevProx     --
text = msg.content_.text_
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@tft4t]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@tft4t]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source DevProx     --
--        Contact         --
...
if DevAbs:get('KDJEONDHOSN:'..DevProx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('KDJEONDHOSN:'..DevProx..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
DevAbs:del('KDJEONDHOSN:'..DevProx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('KDJEONDHOSN:'..DevProx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('KDJEONDHOSN:'..DevProx..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('KDJEONDHOSN:'..DevProx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('KDJEONDHOSN:'..DevProx..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
DevAbs:del('KDJEONDHOSN:'..DevProx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('KDJEONDHOSN:'..DevProx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('KDJEONDHOSN:'..DevProx..'ids:user'..msg.chat_id_)  
...
local BotName = (DevAbs:get(DevProx.."Abs:NameBot") or 'حمد')
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'حمد')
local KDJEONDHOSN = {"لتكول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN[math.random(#KDJEONDHOSN)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'حمد') 
local KDJEONDHOSN = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN[math.random(#KDJEONDHOSN)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(DevProx..'Abs:NameBot') or 'حمد') then 
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'حمد')
local KDJEONDHOSN = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN[math.random(#KDJEONDHOSN)] , 1, 'html') 
return false 
end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
KDJEONDHOSN = '⌁︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
...
KDJEONDHOSN = '⌁︙مبروك لقد ربحت في اللعبه \n⌁︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
...
KDJEONDHOSN = '⌁︙اول واحد يرتبها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
if text == DevAbs:get(DevProx..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(DevProx..'Abs:Games:Ids'..msg.chat_id_) then
...
KDJEONDHOSN = '⌁︙اول واحد يحلها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
if text == DevAbs:get(DevProx..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(DevProx..'Abs:Games:Ids'..msg.chat_id_) then
...
KDJEONDHOSN = '⌁︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
...
KDJEONDHOSN = '⌁︙ما هو عكس كلمة ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
KDJEONDHOSN = '⌁︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
...
KDJEONDHOSN = '⌁︙اكمل المثال التالي ↫ ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
...
if text == 'رياضيات' or text == 'الرياضيات' then
if not DevAbs:get(DevProx..'Abs:Lock:Games'..msg.chat_id_) then
...
KDJEONDHOSN = '⌁︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md')
return false
end end
...
if text == 'الانكليزي' or text == 'الانجليزيه' or text == 'انكليزيه' then
if not DevAbs:get(DevProx..'Abs:Lock:Games'..msg.chat_id_) then
...
--     Source DevProx     --
if text == 'اسئله' or text == 'اختيارات' or text == 'الاسئله' or text == 'اساله' then
if not DevAbs:get(DevProx..'Abs:Lock:Games'..msg.chat_id_) then
...
--     Source DevProx     --
if text and (text == 'الالعاب' or text == 'العاب' or text == 'اللعبه') then
if not DevAbs:get(DevProx..'Abs:Lock:Games'..msg.chat_id_) then
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),KDJEONDHOSN)
end
end
--     Source DevProx     --
...
if tonumber(result.id_) == tonumber(1619524486) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
local KDJEONDHOSN = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md') 
local KDJEONDHOSN = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..KDJEONDHOSN[math.random(#KDJEONDHOSN)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,KDJEONDHOSN)
end
end
--     Source DevProx     --
...
if tonumber(result.sender_user_id_) == tonumber(1619524486) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
local KDJEONDHOSN = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md') 
local KDJEONDHOSN = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..KDJEONDHOSN[math.random(#KDJEONDHOSN)], 1, 'md') 
end 
...
local KDJEONDHOSN = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md') 
local KDJEONDHOSN = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..KDJEONDHOSN[math.random(#KDJEONDHOSN)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local KDJEONDHOSN = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md') 
local KDJEONDHOSN = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..KDJEONDHOSN[math.random(#KDJEONDHOSN)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local KDJEONDHOSN = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,KDJEONDHOSN, 1, 'md') 
local KDJEONDHOSN = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..KDJEONDHOSN[math.random(#KDJEONDHOSN)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
--     Set SecondSudo     --
if Sudo(msg) then
if text ==('اضف مطور ثانوي') or text ==('رفع مطور ثانوي') then
...
if text and (text:match('^اضف مطور ثانوي @(.*)') or text:match('^رفع مطور ثانوي @(.*)')) then
...
if text and (text:match('^اضف مطور ثانوي (%d+)') or text:match('^رفع مطور ثانوي (%d+)')) then
...
--     Source DevProx     --
--     Rem SecondSudo     --
if text ==('حذف مطور ثانوي') or text ==('تنزيل مطور ثانوي') then
...
if text and (text:match('^حذف مطور ثانوي @(.*)') or text:match('^تنزيل مطور ثانوي @(.*)')) then
...
if text and (text:match('^حذف مطور ثانوي (%d+)') or text:match('^تنزيل مطور ثانوي (%d+)')) then
...
--       Set SudoBot      --
if SecondSudo(msg) then
if text ==('اضف مطور') or text ==('رفع مطور') then
function sudo_reply(extra, result, success)
...
if text and (text:match('^اضف مطور @(.*)') or text:match('^رفع مطور @(.*)')) then
...
if text and (text:match('^اضف مطور (%d+)') or text:match('^رفع مطور (%d+)')) then
...
--     Source DevProx     --
--       Rem SudoBot      --
if text ==('حذف مطور') or text ==('تنزيل مطور') then
function prom_reply(extra, result, success)
DevAbs:srem(DevProx..'Abs:SudoBot:',result.sender_user_id_)
...
if text and (text:match('^حذف مطور @(.*)') or text:match('^تنزيل مطور @(.*)')) then
...
if text and (text:match('^حذف مطور (%d+)') or text:match('^تنزيل مطور (%d+)')) then
...
if text and text:match('^رفع مالك (%d+)') then
...
if text and text:match('^تنزيل مالك (%d+)') then
...
if text and text:match('^رفع منظف @(.*)') then
...
if text and text:match('^رفع منظف (%d+)') then
...
if text and text:match('^تنزيل منظف @(.*)') then
...
if text and text:match('^تنزيل منظف (%d+)') then
...
if text == "راسلني" then
KDJEONDHOSN = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,KDJEONDHOSN[math.random(#KDJEONDHOSN)])
end
--     Source DevProx     --
...
DevAbs:set('KDJEONDHOSN:'..DevProx..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('KDJEONDHOSN:'..DevProx.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('KDJEONDHOSN:'..DevProx..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('KDJEONDHOSN:'..DevProx.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
if text == 'تحويل' and not DevAbs:get(DevProx..'Abs:Thwel:Abs'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
DevAbs:set("DevProx:New:id:"..DevProx..msg.sender_user_id_,'KDJEONDHOSN')
return "KDJEONDHOSN"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙رجائا اتبع التعليمات للتعيين \n⌁︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAbs:set("DevProx:New:id:"..DevProx..msg.chat_id_..msg.sender_user_id_,'KDJEONDHOSN')
return "KDJEONDHOSN"
end
...
function KDJEONDHOSN(extra,abbas,success)
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(DevProx..'Abs:Antk:Abs'..msg.chat_id_) then
...
if not DevAbs:get(DevProx..'Abs:Nsba:Abs'..msg.chat_id_) then
if text == "نسبه الكره" or text == "نسبة الكره" then
...
if not DevAbs:get(DevProx..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الرجوله" or text == "نسبة الرجوله" or text == "نسبه رجوله" or text == "نسبة رجوله") then
...
if not DevAbs:get(DevProx..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الانوثه" or text == "نسبة الانوثه" or text == "نسبه انوثه" or text == "نسبة انوثه") then
...
if not DevAbs:get(DevProx..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الغباء" or text == "نسبة الغباء") then
...
if text == "غنيلي" and not DevAbs:get(DevProx..'Abs:Audios:Abs'..msg.chat_id_) then
...
{{text = '⌁ DevProx TeAM .',url="t.me/tft4t"}},
}
...
if text == "الروابط" then if DevAbs:get(DevProx..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الروابط ↫ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(DevProx..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙المعرف ↫ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(DevProx..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙المتحركه ↫ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(DevProx..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الملصقات ↫ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الصور" then if DevAbs:get(DevProx..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الصور ↫ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(DevProx..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الفيديو ↫ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(DevProx..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙الاونلاين ↫ "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(DevProx..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(DevProx..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙التوجيه ↫ "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(DevProx..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الاغاني ↫ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(DevProx..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙الصوت ↫ "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(DevProx..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(DevProx..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(DevProx..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "التعديل" then if DevAbs:get(DevProx..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙التعديل ↫ "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(DevProx..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙التثبيت ↫ "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(DevProx..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(DevProx..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الكلايش ↫ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الدخول" then if DevAbs:get(DevProx..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local KDJEONDHOSN = "\n" .."⌁︙الدخول ↫ "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(DevProx..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الشبكات ↫ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "المواقع" then if DevAbs:get(DevProx..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙المواقع ↫ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "العربيه" then if DevAbs:get(DevProx..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙العربيه ↫ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(DevProx..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local KDJEONDHOSN = "\n" .."⌁︙الانكليزيه ↫ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الكفر" then if DevAbs:get(DevProx..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local KDJEONDHOSN = "\n" .."⌁︙الكفر ↫ "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الفشار" then if DevAbs:get(DevProx..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local KDJEONDHOSN = "\n" .."⌁︙الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(DevProx..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local KDJEONDHOSN = "\n" .."⌁︙الطائفيه ↫ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, KDJEONDHOSN, 1, 'md') end
end
--     Source DevProx     --
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/tft4t' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "tft4t")..")"
else 
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DevProx.lua', '⌁︙نسخة ملف سورس حمد',dl_cb, nil)
end end
--     Source DevProx     --
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help0'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help01'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help21'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help31'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help41'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help51'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local KDJEONDHOSN =  DevAbs:get(DevProx..'Abs:Help61'..msg.sender_user_id_)
if KDJEONDHOSN == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس حمد', 1, 'md') 
os.execute('rm -rf DevProx.lua') 
os.execute('wget https://raw.githubusercontent.com/KDJEONDHOSN/DevProx/master/DevProx.lua') 
dofile('DevProx.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/KDJEONDHOSN/DevProxFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌁︙قائمة ملفات متجر سورس حمد\n⌁︙الملفات المتوفره حاليا ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/KDJEONDHOSN/DevProxFiles/master/DevProxFiles/"..FileName)
if Res == 200 then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@tft4t]', 1, 'md')    
end 
--     Source DevProx     --
